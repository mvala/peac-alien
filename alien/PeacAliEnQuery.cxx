...
//
//int PeacAliEnQuery::DoAuthenticate ( bool showProcess ) {
//
...
//
//
//int PeacAliEnQuery::DoAliEnTokenInit ( bool showProcess ) {
//
//
...
//}
//
//bool PeacAliEnQuery::IsTokenValid(bool /*showProcess*/) {
//
...
//}
//
//bool PeacAliEnQuery::TokenInit ( bool showProcess ) {
//
...
//}
//
//bool PeacAliEnQuery::TokenDestroy ( bool showProcess ) {
...
//
//
//bool PeacAliEnQuery::IsProxyValid(bool showProcess) {
...
//}
//
//bool PeacAliEnQuery::ProxyInit ( bool showProcess ) {
//
//    if ( fXrdgsiproxyCmd.empty() ) {
//        XrdDMLogGFatal ( "Command xrdgsiproxy was not found at compilation time !!!" );
//        XrdDMLogFatal ( "Command xrdgsiproxy was not found at compilation time !!!" );
